...
public class ShadowWindow {
  ...
  private Set<OnFrameMetricsAvailableListener> onFrameMetricsAvailableListeners = new HashSet<>();

  public static Window create(Context context) throws Exception {
    System.out.println("Printing stack trace from Window#create");
    new Throwable().printStackTrace();
    System.out.println("Done printing stack trace from Window#create");
